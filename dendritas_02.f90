...
open(21,file='init_li0_02.dat',status='replace')
do i = 1,n0
...
open(22,file='init_ion_02.dat',status='replace')
do i = 1,nm
...
nt =240
open(23,file='evol_li0_02.dat',status='replace')
open(24,file='evol_lim_02.dat',status='replace')
